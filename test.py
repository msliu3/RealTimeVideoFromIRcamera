...
from PyQt5.QtCore import QMutexLocker, QObject, QThread, QMutex, pyqtSignal
from PyQt5.QtGui import QPixmap, QImage
from PyQt5.QtWidgets import QWidget, QLabel, QPushButton, QHBoxLayout, QStyle, QVBoxLayout, QApplication
from cv2 import *
...
class VideoBox(QWidget):
    ...
    def __init__(self, video_url="", video_type=VIDEO_TYPE_OFFLINE, auto_play=False):
        ...
        super(VideoBox, self).__init__(self)
        # QWidget.__init__(self)

        self.video_url = video_url

        self.video_type = video_type
        # 0: offline  1: realTime

        self.auto_play = auto_play

        self.status = self.STATUS_INIT
        # 0: init 1:playing 2: pause
...
if __name__ == "__main__":
    ...
    #    mw.set_video(None, VideoBox.VIDEO_TYPE_OFFLINE, False)
    mw.show()
    sys.exit(mapp.exec_())
